      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-form layui-form-pane layui-tab-item layui-show">
         ...
         <div class="layui-form layui-form-pane layui-tab-item">
            <div class="layui-form-item">
              <div class="avatar-add">
                <p>建议尺寸140*140，支持jpg、png，最大不能超过4M</p>
                <div class="upload-img">
                  <input type="file" name="file" id="zhifubao" class="layui-upload-file" lay-title="支付宝二维码"> 
                </div>
                <img src="res/images/dashang/img/userpayimg/zhifubao.jpg" id="zhifubaoImg">
                <span class="loading"></span>
              </div>
            </div>
          </div>
          ...
          <div class="layui-form layui-form-pane layui-tab-item">
            <div class="layui-form-item">
              <div class="avatar-add">
                ...
                <img src="res/images/dashang/img/userpayimg/weixin.jpg" id="weixinImg">
                <span class="loading"></span>
              </div>
            </div>
          </div>
